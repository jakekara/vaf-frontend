...
function convertRawItemToPersonDetails(rawItem: any): PersonDetails | undefined {
...
export default function getPersonDetails(options: GetPersonDetailsOptions): Promise<PersonDetails> {

    return new Promise((resolve, reject) => {
        performGET(`q/person/p/id/${options.personID}/results?config=full2`).then((resp: any) => {
